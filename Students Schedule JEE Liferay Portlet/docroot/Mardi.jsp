	...
	String room="";%>
	 ...
	 document.write("<TR>");
	  ...
	  <%for (int i=0; i<horaire.size(); i++) {%>
		     ...
		     build="";
			    subclass=cells.get(i*horaire.size()+1).getSubclass1();
				 course=cells.get(i*horaire.size()+1).getCourse1();
				 teacher=cells.get(i*horaire.size()+1).getTeacher1();
				room=cells.get(i*horaire.size()+1).getRoom1();

	...
	String room="";%>
	 ...
	 document.write("<TR>");
	  ...
	  <%for (int i=0; i<horaire.size(); i++) {%>
		     ...
		     build="";
			    subclass=cells.get(i*horaire.size()).getSubclass1();
				 course=cells.get(i*horaire.size()).getCourse1();
				 teacher=cells.get(i*horaire.size()).getTeacher1();
				room=cells.get(i*horaire.size()).getRoom1();
